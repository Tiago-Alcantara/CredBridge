...
describe('StellarService', () => {
  ...
  it('tops up an existing testnet account to the target balance when it is below the minimum', async () => {
    const service = createService();
    ...
    const transaction = submitWithDetail.mock.calls[0][0] as Transaction;
    const paymentOperation = transaction.operations[0] as Operation.Payment;
